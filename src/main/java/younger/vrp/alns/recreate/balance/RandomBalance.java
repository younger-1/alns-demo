...
public class RandomBalance extends ALNSAbstractRecreate implements IALNSRecreate {

    private RandomBalance() {
        this.random = new Random();
    }

    public static RandomBalance of() {
